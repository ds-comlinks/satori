package marketing.satori.kintone.csv.app.wrnosegment;
...
/**
 *
 * Web行動履歴(Segment非該当)へのPOSTリクエストです。
 *
 */
public class WRNoSegmentPostRequest extends KintonePostRequest {

	/** マスタデータ */
	KeyRecordMap masterMap;

	public WRNoSegmentPostRequest(KintoneHost host, KeyRecordMap masterMap) throws JSONException {
		super(host, host.getWRNoSegment());
