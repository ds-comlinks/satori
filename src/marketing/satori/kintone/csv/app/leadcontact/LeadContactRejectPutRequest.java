...
public class LeadContactRejectPutRequest extends KintonePutRequest {

	public LeadContactRejectPutRequest(KintoneHost host) throws JSONException {
	...
	public void put(Map<String, String> csvRecord) throws JSONException {
		...
		KintoneRequest.addJsonValueRecordItem(recordObj, "HasOptedOutOfEmail", "reject");
